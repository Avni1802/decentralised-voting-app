    ...
    <div className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md overflow-hidden dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="p-5">
        ...
        <div className="flex justify-between">
          <Badge color="gray" variant="default" className="text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
            starts at {startTime}
          </Badge>
          <Badge color="gray" variant="default" className="text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
            ends at {endTime}
      ...
      <div className="w-full rounded-3xl bg-gray-800 p-6">
        ...
        {ballots.map((ballot, index) => (
          <MyCardComponent
            ...
            description={ballot.candidates.map(obj => obj.partyName).join(", ")}
